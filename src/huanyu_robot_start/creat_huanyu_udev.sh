...
echo  'KERNEL=="ttyUSB*", ATTRS{idVendor}=="10c4", ATTRS{idProduct}=="ea60",ATTRS{serial}=="0001", MODE:="0777", GROUP:="dialout",  SYMLINK+="huanyu_rplidar"' >/etc/udev/rules.d/huanyu_rplidar.rules
service udev reload
sleep 2
